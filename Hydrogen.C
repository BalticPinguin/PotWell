...
//https://github.com/libMesh/libmesh/wiki/Source-code-formatting-conventions
...
// TODO: run doxygen on it.
// mesh-creation --> is tetgen in the examples? Can I do something nice with it? (e.g.: verbose output or so)
...
// TODO: is this needed? Anyway, nice to show this feature. Is it used in some other example?
...
void line_print(EquationSystems& es, std::string output, std::string SysName){
  ...
  // TODO: this is only important for parallelisation, I guess?
  // I definitely should run this example in parallel for testing...
